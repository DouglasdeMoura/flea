...
function run(check) {
    ...
    check("shift delete deletes for good", Keymap.lookup(Qt.Key_Delete, "", shift), "delete")
    ...
    // The preset chooser itself is keymap-presets.js, split out at the 300-line hard cap.
}
